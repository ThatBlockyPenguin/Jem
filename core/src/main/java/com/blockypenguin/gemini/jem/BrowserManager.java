...
public final class BrowserManager {
    ...
    static void setUserInterface(IUserInterface ui) {
        if(userInterface == null) userInterface = ui;
        else throw new IllegalStateException("Cannot set User Interface more than once!");
    }
    ...
    public static void showErrorDialogue(Logger logger, Throwable t, String msg, Object... params) {
        ...
        if(t != null) {
            ...
            params[params.length - 1] = CoreUtils.getStackTrace(t);
        }
        ...
        SwingUtilities.invokeLater(() ->
            createMsgURL(
                ...
                () -> userInterface.setRendererComponent(null)
            )
        );
    }
    
    private static Optional<URL> createMsgURL(String message) {
        return CoreUtils.createURLWithHandler(URI.create("msg://" + URLEncoder.encode(message, StandardCharsets.UTF_8)));
    }
}